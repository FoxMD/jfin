...
public class FinanceModelTest {
    ...
    void modelTest() {
        ...
        assertEquals(this.testValue, testModel.getChartValues());

        assertEquals(this.testValue, testModel.getTest());

        testModel.setChartValues(this.testValue);
        assertEquals(this.testValue * 2, testModel.getTest());

        testModel.setIncome(this.incomeTest);
        testModel.setExpenses(this.expenseTest);
